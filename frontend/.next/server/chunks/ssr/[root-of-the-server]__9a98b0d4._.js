...
const Cart = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const fetchUserData = async ()=>{
            if (user?.id) {
                try {
                    const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:3001/api")}/users/${user.id}`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9a98b0d4._.js.map